 ...
 */
class doccreatorbox extends ModeleBoxes
{

    public $boxcode = "mybox";
    public $boximg = "doccreator@doccreator";
    public $boxlabel;
    public $depends = array("doccreator");
    public $db;
    public $param;
    ...
    public function loadBox($max = 5)
    {
        ...
        //include_once DOL_DOCUMENT_ROOT . "/doccreator/class/doccreator.class.php";
